...
API_ID = int(getenv("API_ID", "23860620"))
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001909345858"))
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6043672660").split())
